...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header d-sm-flex align-items-center justify-content-between py-3">
            <h6 class="m-0 font-weight-bold text-primary">CreateTable Book</h6>
        ...
        <div class="card-body">
            <form method="POST" action="/dashboard/book/{{ $book->slug }}" class="mb-5" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <div class="mb-3">
                  <label for="title" class="form-label">Title</label>
                  <input type="text" class="form-control" id="title" name="title" required autofocus value="{{ old('title', $book->title) }}"> 
                </div>
                
                <div class="mb-3">
                    <label for="writter" class="form-label">Writer</label>
                    <input type="text" class="form-control" id="writer" name="writer" required  value="{{ old('writer', $book->writer) }}"> 
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="no_isbn" value="{{ old('no_isbn', $book->no_isbn) }}">
                      </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                            ...
                            <input type="hidden" name="oldImage" value="{{ $book->cover_image }}">
